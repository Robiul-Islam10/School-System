...
?>
		...
		<body>
			...
			<tr>
			<td align="center" colspan="3"><h1>Post Event</h1></td>
			</tr>
			<tr>
			<td width=30%>
			...
			<td>
				...
				<td>
					<form method="post" action="../php/eventcheck.php" onsubmit="return check1()" enctype="multipart/form-data">
					...
					<td><h3>Title</h3></td>
					<td><h3>:</h3></td>
					<td><h3><textarea name="title" id="t" style="resize: none;" cols="75"> </textarea></h3></td>
					...
					<td><h3>Date</h3></td>
					<td><h3>:</h3></td>
					<td><h3> Day:<input type="text" name="day" id="d"><br> Month: <input type="text" name="month" id="m"><br> Year: <input type="text" name="year" id="y"></h3></td>
					<tr>
					</tr>
					<tr>
			...
			var check = function()
				{
					...
					{
						//onsubmit=false;
						alert("Please Enter Body of Event");
						//alert (flag);
						//location.href = "http://localhost/examfinal/reg.php";
