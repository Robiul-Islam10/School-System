<?php
	...
	if(isset($_SESSION['name'])){
		...
		$conn = getConnection();
			$sql = "SELECT instructions FROM `admission`";
...
?>
		...
		<body>
			...
			<tr>
			<td align="center" colspan="3"><h1>Admission Requirements</h1></td>
			</tr>
			<tr>
			<td width=30%>
			...
			<td>
				<form method="post" action="../php/admissioncheck.php" onsubmit="return check1()" enctype="multipart/form-data">
				<table height=400 width=80% align="center">
				
				
				<tr>
				<td align="center"><h2>Set Instructions:</h2></td>
				</tr>
				<tr>
				<td><div align="center">
