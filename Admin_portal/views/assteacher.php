...
?>
		...
		<body>
			...
			<tr>
			<td align="center" colspan="3"><h1>Assign Teachers to Classes</h1></td>
			</tr>
			<tr>
			<td width=30%>
			...
			<td>
				<form method="post" action="../php/assignteachercheck.php" onsubmit="return check1()" enctype="multipart/form-data">
				<table border="1" height=500 width=100%>
				<tr>
					<td colspan="2" align="center"><h3>Subject : <select name="grade" id="ss" onchange="test(this)">
				...
				<tr >
					<td colspan="2" align="center"><h3>Grade : <select name="class">
				...
				<tr>
				<td width=50% align="center"><h2>Teachers List:</h2></td>
				</tr>
				<tr>
				<td align="center">
				...
				//$key="Bangla";
				$conn = getConnection();
				$sql = "select tid from teacher where subject='Bangla'";
				...
				?>
					...
					<tr>
						<td align="center"><?php echo $row['tid'] ;?><br></td>
				...
				<tr>
					<h3><td align="center" colspan="2"><input type="text" name="stid" id="input"> <input type="submit" name="submit" onclick="check()" value="Assign"></h3></td>
				</tr>
			</table>
			...
			<script type="text/javascript">
				...
				var test= function(e)
				{
					...
					xmlHttp.open('POST', '../php/search1.php', true);
