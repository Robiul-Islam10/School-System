<?php
	...
	if(isset($_SESSION['name'])){
		...
		$conn = getConnection();
			$sql = "SELECT contact FROM `contactus`";
...
?>
		...
		<body>
			...
			<tr>
			<td align="center" colspan="3"><h1>Contact Us Information</h1></td>
			</tr>
			<tr>
			<td width=30%>
			...
			<td>
				<form method="post" action="../php/contactcheck.php" onsubmit="return check1()" enctype="multipart/form-data">
				<table height=400 width=80% align="center">
				
				
				<tr>
				<td align="center"><h2>Edit Contact Us:</h2></td>
				</tr>
				<tr>
				<td><div align="center">
