<?php
	...
	if(isset($_SESSION['name'])){
		...
		$conn = getConnection();
			...
			$sql = "SELECT * FROM `parents` where pid={$latest}";
...
?>
		...
		<body>
			...
			<td>
				<form method="post" action="../php/updatecheckpar.php" onsubmit="return check1()" enctype="multipart/form-data">
				<fieldset>
				<table height=500 align= "center">
				<tr>
					<td align="left"><h3>Name </h3></td>
					<td><h3>:</h3></td>
					<td><input type="text" name="pname" id="pn" value=<?php echo htmlspecialchars($row['pname']); ?> ></td>
				...
				<tr>
					...
					<td><h3><input type="text" name="psid" id="po" value=<?php echo htmlspecialchars($row['child']); ?> readonly ></h3></td>
				...
				<tr>
					...
					<td><h3><input type="text" name="con" id="c" value=<?php echo htmlspecialchars($row['contact']); ?> ></h3></td>
				...
				<tr>
					...
					<td><h3><input type="text" name="pn" id="pnid" value=<?php echo htmlspecialchars($row['nid']); ?> ></h3></td>
