<?php
	...
	if(isset($_SESSION['name'])){
		...
		$conn = getConnection();
			...
			$sql = "SELECT * FROM `student` where sid={$latest}";
...
?>
		...
		<body>
			...
			<td>
				<form method="post" action="../php/upcheckstu.php" onsubmit="return check1()" enctype="multipart/form-data">
				<fieldset>
				<table height=500 align= "center">
				<tr>
					<td align="left"><h3>Name </h3></td>
					<td><h3>:</h3></td>
					<td><h3><input type="text" name="sname" id="sn" value="<?php echo htmlspecialchars($row['sname']); ?>"></h3></td>
